...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--output", help="Output video file path (default: output/<video>_overclocked.mp4)")
    p.add_argument("--mode", choices=["render", "debug", "live"], help="Output mode (default: render)")
